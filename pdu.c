...
#endif
        sRange gsm7_legal[] = {
            {10, 10},    {13, 13},   {32, 95},   {97, 126},  {161, 161}, {163, 167}, {191, 191},
            {196, 201},  {209, 209}, {214, 214}, {216, 216}, {220, 220}, {223, 224}, {228, 230},
            {232, 233},  {236, 236}, {241, 242}, {246, 246}, {248, 249}, {252, 252}, {915, 916},
            {920, 920},  {923, 923}, {926, 926}, {928, 928}, {931, 931}, {934, 934}, {936, 937}, // greek
            {8364, 8364}                                                                         // euro
};
 ...
 */
int PDU_encode(const char *SCA, bool ReplayPath, bool headerPresent, bool statusReport, PDU_VPF_t VPF_Format,
               int messageReference, const char *recipient, int VPF_Value, const char *message, int items, ...)
{
  char udhBuffer[10];
  ...
  */
  ...
  {
  case DCS_7BIT:
    tempBuffer[bufferHead++] = DCS_7BIT;
    break;
  case DCS_8BIT:
    tempBuffer[bufferHead++] = DCS_8BIT;
    break;
  case DCS_16BIT:
    tempBuffer[bufferHead++] = DCS_16BIT;
    break;
  }
  /* Set Validity Period */
  if (VPF_Format != VPF_NOT_PRESENT)
  ...
  *pduBuffer = 0;
  if (deliverHeader.PDU_TYPE.deliver.UDHI)
  {
    ...
    case 6:
      ...
      index += 2;
      if ((udhlength == 5 && IEI == 0 && IEILength == 3) ||
          (udhlength == 6 && IEI == 8 && IEILength == 4)) // TODO support other header type
      {
